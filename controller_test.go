...
import (
	...
	app "k8s.io/app-controller/pkg/apis/appcontroller/v1alpha1"
	"k8s.io/app-controller/pkg/generated/clientset/versioned/fake"
	informers "k8s.io/app-controller/pkg/generated/informers/externalversions"
)
...
func newFoo(name string, replicas *int32) *app.Foo {
	return &app.Foo{
		TypeMeta: metav1.TypeMeta{APIVersion: app.SchemeGroupVersion.String()},
